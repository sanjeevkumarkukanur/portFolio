...
const Portfolio = () => {
    ...
    const portfolios = [
        {
            id:1,
            src:"https://www.notionwizard.com/wp-content/uploads/2021/01/income-and-expenses-illustration.jpg"
        },
        {
            id:2,
            src:installNode
                ...
                portfolios.map(({id, src})=>(
                    ...
                    <div key={id} className='shadow-md shadow-gray-600 rounded-lg'>
                            ...
                            <div className='flex justify- items-center'>
                                <button className='w-1/2 mx-6 py-3 m-1 duration-200 hover:scale-105'>Demo</button>
                                <button className='w-1/2 mx-6 py-3 m-1 duration-200 hover:scale-105'>Code</button>
                            </div>
                        </div>
